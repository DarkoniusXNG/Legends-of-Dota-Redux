-- Hyper Active
LinkLuaModifier("modifier_ham_oaa", "abilities/oaa/hyper_active.lua", LUA_MODIFIER_MOTION_NONE)

hyper_active_oaa = class({})

function hyper_active_oaa:GetIntrinsicModifierName()
	return "modifier_ham_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_ham_oaa = class({})
...
modifier_ham_oaa.OnRefresh = modifier_ham_oaa.OnCreated
