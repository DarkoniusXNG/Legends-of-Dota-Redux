-- Spell Resistance (Spell Block, magic resist, status resist, slow resist)
LinkLuaModifier("modifier_spell_block_oaa", "abilities/oaa/spell_resistance.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spell_block_cooldown_oaa", "abilities/oaa/spell_resistance.lua", LUA_MODIFIER_MOTION_NONE)

spell_resistance_oaa = class({})

function spell_resistance_oaa:GetIntrinsicModifierName()
	return "modifier_spell_block_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_spell_block_oaa = class({})
...
function modifier_spell_block_oaa:GetModifierSlowResistance_Stacking()
...
modifier_spell_block_cooldown_oaa = class({})
