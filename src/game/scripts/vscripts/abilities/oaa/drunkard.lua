-- Drunkard
LinkLuaModifier("modifier_drunk_oaa", "abilities/oaa/drunkard.lua", LUA_MODIFIER_MOTION_NONE)

drunkard_oaa = class({})

function drunkard_oaa:GetIntrinsicModifierName()
	return "modifier_drunk_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_drunk_oaa = class({})
