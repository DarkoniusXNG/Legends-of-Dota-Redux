-- Moriah's Shield
LinkLuaModifier("modifier_hp_mana_switch_oaa", "abilities/oaa/moriahs_shield.lua", LUA_MODIFIER_MOTION_NONE)

moriah_shield_oaa = class({})

function moriah_shield_oaa:GetIntrinsicModifierName()
	return "modifier_hp_mana_switch_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_hp_mana_switch_oaa = class({})
