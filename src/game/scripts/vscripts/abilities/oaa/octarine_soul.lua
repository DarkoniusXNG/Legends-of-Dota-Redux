-- Octarine Soul
LinkLuaModifier("modifier_octarine_soul_oaa", "abilities/oaa/octarine_soul.lua", LUA_MODIFIER_MOTION_NONE)

octarine_soul_oaa = class({})

function octarine_soul_oaa:GetIntrinsicModifierName()
	return "modifier_octarine_soul_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_octarine_soul_oaa = class({})
