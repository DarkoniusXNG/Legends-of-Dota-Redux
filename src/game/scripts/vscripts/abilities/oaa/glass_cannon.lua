LinkLuaModifier("modifier_glass_cannon_oaa", "abilities/oaa/glass_cannon.lua", LUA_MODIFIER_MOTION_NONE)

glass_cannon_oaa = class({})

function glass_cannon_oaa:GetIntrinsicModifierName()
	return "modifier_glass_cannon_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_glass_cannon_oaa = class({})
