LinkLuaModifier("modifier_hybrid_oaa", "abilities/oaa/hybrid.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hybrid_dmg_stack_oaa", "abilities/oaa/hybrid.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hybrid_spell_amp_stack_oaa", "abilities/oaa/hybrid.lua", LUA_MODIFIER_MOTION_NONE)

hybrid_oaa = class({})

function hybrid_oaa:GetIntrinsicModifierName()
	return "modifier_hybrid_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_hybrid_oaa = class({})
...
modifier_hybrid_oaa.OnRefresh = modifier_hybrid_oaa.OnCreated
...
modifier_hybrid_dmg_stack_oaa = class({})
...
modifier_hybrid_spell_amp_stack_oaa = class({})
