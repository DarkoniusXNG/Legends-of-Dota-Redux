LinkLuaModifier("modifier_brute_oaa", "abilities/oaa/brute.lua", LUA_MODIFIER_MOTION_NONE)

brute_oaa = class({})

function brute_oaa:GetIntrinsicModifierName()
	return "modifier_brute_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_brute_oaa = class({})
...
modifier_brute_oaa.OnRefresh = modifier_brute_oaa.OnCreated
