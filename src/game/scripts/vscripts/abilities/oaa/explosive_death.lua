-- Explosive Death (OAA version)
LinkLuaModifier("modifier_explosive_death_oaa", "abilities/oaa/explosive_death.lua", LUA_MODIFIER_MOTION_NONE)

explosive_death_oaa = class({})

function explosive_death_oaa:GetIntrinsicModifierName()
	return "modifier_explosive_death_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_explosive_death_oaa = class({})

function modifier_explosive_death_oaa:IsHidden()
  return false -- to see last dmg done
end
