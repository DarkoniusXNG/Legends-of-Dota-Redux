-- Battlemage (Spell dmg procs attacks)
LinkLuaModifier("modifier_battlemage_oaa", "abilities/oaa/battlemage.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_battlemage_cooldown_oaa", "abilities/oaa/battlemage.lua", LUA_MODIFIER_MOTION_NONE)

battlemage_oaa = class({})

function battlemage_oaa:GetIntrinsicModifierName()
  return "modifier_battlemage_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_battlemage_oaa = class({})
...
modifier_battlemage_oaa.OnRefresh = modifier_battlemage_oaa.OnCreated
...
modifier_battlemage_cooldown_oaa = class({})
