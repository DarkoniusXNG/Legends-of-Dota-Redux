-- Magus (Attacks cast spells OAA version)
LinkLuaModifier("modifier_magus_oaa", "abilities/oaa/magus.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_magus_cooldown_oaa", "abilities/oaa/magus.lua", LUA_MODIFIER_MOTION_NONE)

magus_oaa = class({})

function magus_oaa:GetIntrinsicModifierName()
	return "modifier_magus_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_magus_oaa = class({})
...
function modifier_magus_oaa:OnCreated()
  ...
  self.ignore_abilities = {
	...
	abyssal_underlord_cancel_dark_rift = 1,              -- self grief
	abyssal_underlord_cancel_dark_rift_oaa = 1,          -- self grief
    alchemist_unstable_concoction = 1,                   -- self grief
    angel_arena_tome_agi = 1,                            -- powerful
    angel_arena_tome_agi_op = 1,                         -- powerful
    angel_arena_tome_gods = 1,                           -- powerful
    angel_arena_tome_gods_op = 1,                        -- powerful
    angel_arena_tome_int = 1,                            -- powerful
    angel_arena_tome_int_op = 1,                         -- powerful
    angel_arena_tome_lvlup = 1,                          -- powerful
    angel_arena_tome_lvlup_op = 1,                       -- powerful
    angel_arena_tome_med = 1,                            -- powerful
    angel_arena_tome_med_op = 1,                         -- powerful
    angel_arena_tome_str = 1,                            -- powerful
    angel_arena_tome_str_op = 1,                         -- powerful
    --angel_arena_transmute = 1,                           -- instant kill (not able to target heroes in code)
    ...
    chen_holy_persuasion = 1,                            -- instant kill, dominating every creep or hero on attack
    ...
    --doom_bringer_devour_lod = 1,                         -- instant kill (not able to target heroes in code)
    earth_spirit_petrify = 1,                            -- invulnerability and trolling, DOTA_UNIT_TARGET_TEAM_CUSTOM
    --eat_tree_eldri = 1,                                  -- DOTA_UNIT_TARGET_TREE (not able to target heroes in code)
    --earth_spirit_rolling_boulder = 1,                    -- bugs out?
    elder_titan_move_spirit = 1,                         -- self grief
    elder_titan_return_spirit = 1,                       -- self grief
    --eldri_anti_magic = 1,                                -- DOTA_UNIT_TARGET_TREE (not able to target heroes in code)
    ember_spirit_activate_fire_remnant = 1,              -- self grief
    --enraged_wildkin_tornado = 1,                         -- multiplies?
    ...
    --imba_lich_dark_ritual = 1,                         -- (not able to target heroes in code)
    imba_tiny_tree_grab = 1,                             -- DOTA_UNIT_TARGET_TREE, DOTA_UNIT_TARGET_CUSTOM
    imba_tiny_tree_throw = 1,                            -- self grief
    imba_ursa_territorial_hunter = 1,                    -- DOTA_UNIT_TARGET_TREE
    --keen_commander_recon_systems = 1,                    -- DOTA_UNIT_TARGET_TREE (not able to target heroes in code)
    ...
    lich_death_charge = 1,                               -- instant kill allies or self
    life_stealer_consume = 1,                            -- self grief
    life_stealer_infest = 1,                             -- self grief and maybe instant kill, DOTA_UNIT_TARGET_TEAM_CUSTOM
    lina_banana = 1,                                     -- DOTA_UNIT_TARGET_TREE
    lina_banana_redux = 1,                               -- DOTA_UNIT_TARGET_TREE
    lina_coconut = 1,                                    --	DOTA_UNIT_TARGET_TREE
    lina_coconut_redux = 1,                              -- DOTA_UNIT_TARGET_TREE
    lina_grapefruit = 1,                                 -- DOTA_UNIT_TARGET_TREE
    lina_grapefruit_redux = 1,                           -- DOTA_UNIT_TARGET_TREE
    meepo_megameepo_fling = 1,                           -- self grief
    meepo_petrify = 1,                                   -- invulnerability
    monkey_king_primal_spring = 1,                       -- breaks ability
    --monkey_king_primal_spring_early = 1,                 -- self grief
    monkey_king_tree_dance = 1,                          -- self grief in most cases, breaks Primal Spring
    monkey_king_wukongs_command = 1,                     -- lag
    morphling_hybrid = 1,                                -- bugs out, DOTA_UNIT_TARGET_TEAM_CUSTOM
    ...
    phoenix_sun_ray_toggle_move = 1,                     -- self grief
    ...
    tiny_tree_grab = 1,                                  -- bugged, DOTA_UNIT_TARGET_TEAM_CUSTOM, DOTA_UNIT_TARGET_CUSTOM, DOTA_UNIT_TARGET_TREE
    treant_eyes_in_the_forest = 1,                       -- bugged, DOTA_UNIT_TARGET_TREE
    ...
    --undying_soul_rip_op = 1,                           -- uncomment if there are issues, DOTA_UNIT_TARGET_TEAM_CUSTOM
...
modifier_magus_cooldown_oaa = class({})
