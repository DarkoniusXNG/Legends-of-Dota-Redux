abyssal_underlord_dark_rift_oaa = class({})

LinkLuaModifier("modifier_underlord_dark_rift_oaa_stun", "abilities/oaa/oaa_dark_rift.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
LinkLuaModifier("modifier_underlord_dark_rift_oaa_scepter_buff", "abilities/oaa/oaa_dark_rift.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
...
function abyssal_underlord_dark_rift_oaa:OnSpellStart()
  ...
  for _, unit in pairs(units_in_portal) do
    unit:AddNewModifier(caster, self, "modifier_underlord_dark_rift_oaa_stun", {duration = stun_duration})
    -- Apply damage
...
modifier_underlord_dark_rift_oaa_stun = class({})
...
modifier_underlord_dark_rift_oaa_scepter_buff = class({})
