-- Rend
LinkLuaModifier("modifier_rend_oaa", "abilities/oaa/rend.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_rend_armor_reduction_oaa", "abilities/oaa/rend.lua", LUA_MODIFIER_MOTION_NONE)

rend_oaa = class({})

function rend_oaa:GetIntrinsicModifierName()
	return "modifier_rend_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_rend_oaa = class({})
...
modifier_rend_armor_reduction_oaa = class({})
