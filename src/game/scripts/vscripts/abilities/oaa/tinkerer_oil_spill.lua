LinkLuaModifier("modifier_tinkerer_oil_spill_thinker", "abilities/oaa/tinkerer_oil_spill.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tinkerer_oil_spill_debuff", "abilities/oaa/tinkerer_oil_spill.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
LinkLuaModifier("modifier_tinkerer_oil_spill_root", "abilities/oaa/tinkerer_oil_spill.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
