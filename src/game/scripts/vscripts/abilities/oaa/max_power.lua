-- Max Power
LinkLuaModifier("modifier_any_damage_crit_oaa", "abilities/oaa/max_power.lua", LUA_MODIFIER_MOTION_NONE)

max_power_oaa = class({})

function max_power_oaa:GetIntrinsicModifierName()
	return "modifier_any_damage_crit_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_any_damage_crit_oaa = class({})
