-- Multicast (OAA version)
LinkLuaModifier("modifier_multicast_oaa", "abilities/oaa/multicast.lua", LUA_MODIFIER_MOTION_NONE)

multicast_oaa = class({})

function multicast_oaa:GetIntrinsicModifierName()
	return "modifier_multicast_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_multicast_oaa = class({})
...
function modifier_multicast_oaa:OnCreated()
  ...
  self.ignore_abilities = {
    abyssal_underlord_cancel_dark_rift = 1,              -- useless
    ...
    chen_holy_persuasion = 1,                            -- instant kill, dominating every creep or hero
    ...
    enraged_wildkin_tornado = 1,                         -- multiplies Tornados
    ...
    furion_teleportation = 1,                            -- useless
    --furion_wrath_of_nature = 1,                        -- powerful
    ...
    imba_tiny_tree_throw = 1,                            -- useless
    ...
    lich_death_charge = 1,                               -- instant kill
    ...
    monkey_king_primal_spring_early = 1,                 -- useless
    ...
    windrunner_focusfire_cancel = 1,                     -- useless
    --winter_wyvern_cold_embrace = 1,                    -- grief
    wisp_spirits_in = 1,                                 -- useless
    wisp_spirits_out = 1,                                -- useless
    wisp_tether_break = 1,                               -- useless
    --witch_doctor_death_ward = 1,                         -- powerful or bugs out?
    witch_doctor_voodoo_switcheroo = 1,                  -- multiplies or useless
    --zuus_cloud = 1,                                    -- powerful
