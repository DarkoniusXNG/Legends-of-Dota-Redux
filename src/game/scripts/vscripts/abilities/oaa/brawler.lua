LinkLuaModifier("modifier_brawler_oaa", "abilities/oaa/brawler.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_brawler_stack_oaa", "abilities/oaa/brawler.lua", LUA_MODIFIER_MOTION_NONE)

brawler_oaa = class({})

function brawler_oaa:GetIntrinsicModifierName()
  return "modifier_brawler_oaa"
end

---------------------------------------------------------------------------------------------------

modifier_brawler_oaa = class({})
...
modifier_brawler_oaa.OnRefresh = modifier_brawler_oaa.OnCreated
...
modifier_brawler_stack_oaa = class({})
