...
LinkLuaModifier("modifier_techies_custom_land_mine", "abilities/techies_land_mines_old.lua", LUA_MODIFIER_MOTION_NONE)
...
function techies_custom_land_mines:OnSpellStart()
	...
	mine:SetDeathXP(14)
	mine:SetMaximumGoldBounty(25)
	mine:SetMinimumGoldBounty(25)
