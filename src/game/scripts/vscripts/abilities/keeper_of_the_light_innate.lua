...
function modifier_keeper_of_the_light_innate_redux:DeclareFunctions()
  return {
    MODIFIER_PROPERTY_BONUS_DAY_VISION,
  }
end

function modifier_keeper_of_the_light_innate_redux:GetBonusDayVision()
  local parent = self:GetParent()
...
function modifier_keeper_of_the_light_innate_redux:CheckState()
  local parent = self:GetParent()
  return {
