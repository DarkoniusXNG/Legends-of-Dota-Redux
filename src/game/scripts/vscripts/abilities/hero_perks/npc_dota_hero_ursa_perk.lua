--------------------------------------------------------------------------------------------------------
--		Hero: Ursa
--		Perk: Ursa does 25% extra damage to neutrals, including Roshan.
--------------------------------------------------------------------------------------------------------
modifier_npc_dota_hero_ursa_perk = modifier_npc_dota_hero_ursa_perk or class({})
--------------------------------------------------------------------------------------------------------
...
function modifier_npc_dota_hero_ursa_perk:GetModifierTotalDamageOutgoing_Percentage(keys)
	...
	if target and target:GetTeamNumber() == DOTA_TEAM_NEUTRALS then
		return 25
	else 
		return 0
	end
