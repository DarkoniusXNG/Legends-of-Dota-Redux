--------------------------------------------------------------------------------------------------------
--		Hero: Night Stalker
--		Perk: Lifesteal and Spell lifesteal during the night
--------------------------------------------------------------------------------------------------------
...
--function modifier_npc_dota_hero_night_stalker_perk:OnIntervalThink()
...
function modifier_npc_dota_hero_night_stalker_perk:DeclareFunctions()
	return {
        --MODIFIER_PROPERTY_PHYSICAL_LIFESTEAL, -- it works but we dont want it in this case because it requires OnIntervalThink
        --MODIFIER_PROPERTY_MAGICAL_LIFESTEAL, -- it doesn't seem to work, idk why
		MODIFIER_EVENT_ON_TAKEDAMAGE,
	}
end

--function modifier_npc_dota_hero_night_stalker_perk:GetModifierProperty_PhysicalLifesteal()
...
--function modifier_npc_dota_hero_night_stalker_perk:GetModifierProperty_MagicalLifesteal()
    --if math.abs(self:GetStackCount()) == 1 then
...
if IsServer() then
	function modifier_npc_dota_hero_night_stalker_perk:OnTakeDamage(event)
