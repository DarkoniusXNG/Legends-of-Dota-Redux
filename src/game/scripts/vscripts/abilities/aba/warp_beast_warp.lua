LinkLuaModifier("modifier_warp", "abilities/aba/warp_beast_warp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_warp_indicator", "abilities/aba/warp_beast_warp.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
LinkLuaModifier("modifier_warp_effect", "abilities/aba/warp_beast_warp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_warp_castrange_buffer", "abilities/aba/warp_beast_warp.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mana_eater_bonus_mana_count", "abilities/aba/warp_beast_warp.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
...
function warp_beast_warp:Warp(maxCastRange, castPosition, ability, order)
	...
	EmitSoundOnLocationWithCaster(warpPosition, "Hero_Warp_Beast.WarpOut", caster)
	...
	EmitSoundOnLocationWithCaster(caster:GetAbsOrigin(), "Hero_Warp_Beast.WarpIn", caster)
