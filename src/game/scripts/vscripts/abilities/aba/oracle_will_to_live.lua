...
LinkLuaModifier("modifier_oracle_will_to_live", "abilities/aba/oracle_will_to_live.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
LinkLuaModifier("modifier_oracle_will_to_live_delay", "abilities/aba/oracle_will_to_live.lua", LUA_MODIFIER_MOTION_NONE)
