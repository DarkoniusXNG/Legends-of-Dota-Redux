...
LinkLuaModifier("modifier_bubble_witch_blow_bubbles_caster", "abilities/aba/bubble_witch_blow_bubbles.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
LinkLuaModifier("modifier_bubble_witch_blow_bubbles_ally", "abilities/aba/bubble_witch_blow_bubbles.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
LinkLuaModifier("modifier_bubble_witch_blow_bubbles_enemy", "abilities/aba/bubble_witch_blow_bubbles.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
