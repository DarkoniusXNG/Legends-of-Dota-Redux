...
LinkLuaModifier("modifier_bubble_witch_bubble_of_protection_debuff", "abilities/aba/bubble_witch_bubble_of_protection.lua", LUA_MODIFIER_MOTION_NONE) -- needs tooltip
