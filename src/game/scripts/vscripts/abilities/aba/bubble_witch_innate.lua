LinkLuaModifier("modifier_bubble_witch_innate_oaa", "abilities/aba/bubble_witch_innate.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bubble_witch_innate_buff_oaa", "abilities/aba/bubble_witch_innate.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bubble_witch_innate_immune_oaa", "abilities/aba/bubble_witch_innate.lua", LUA_MODIFIER_MOTION_NONE)
