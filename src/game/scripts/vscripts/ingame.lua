...
function Ingame:FilterModifyGold(filterTable)
    ...
    if goldModifier ~= 100 and goldModifier >= 0 and goldModifier <= 1000 then
        if reason == DOTA_ModifyGold_HeroKill or reason == DOTA_ModifyGold_GameTick or reason == DOTA_ModifyGold_Building or reason == DOTA_ModifyGold_SharedGold or reason == DOTA_ModifyGold_BountyRune then
            local newGold = oldGold * goldModifier / 100
            filterTable.gold = newGold
        end
    end
